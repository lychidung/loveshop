    ...
    <div class="flex items-center self-center gap-x-10 h-1/2">
        ...
        <div class="flex-auto ml-10">
            <ul class="flex gap-x-5">
                <li class="p-2 border-2 rounded-2xl hover:bg-color-main-2">
                    <a href="" class=""> <img src="/images_icon/facebook_white.png" alt=""> </a>
                </li>

                <li class="p-2 border-2 rounded-2xl hover:bg-color-main-2">
                    <a href="" class=""> <img src="/images_icon/instagram_white.png" alt=""> </a>
                </li>

                <li class="p-2 border-2 rounded-2xl hover:bg-color-main-2">
                    <a href="" class=""> <img src="/images_icon/tiktok_white.png" alt=""> </a>
                </li>
            </ul>
        </div>
    </div>
